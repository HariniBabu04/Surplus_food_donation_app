...
<div class="container mt-4">
  ...
  <div class="row mb-3">
    <div class="col-md-4">
      <input type="text" class="form-control" placeholder="Search by food name, donor, NGO" id="searchBox">
    </div>
    <div class="col-md-3">
      ...
      <tbody>
        <tr class="text-nowrap">
          ...
          <td>
            ...
            <button class="btn btn-sm btn-outline-warning" onclick="window.location.href='editDonation  '">Edit</button>
            <button class="btn btn-sm btn-outline-danger cancel-btn" data-bs-toggle="modal" data-bs-target="#cancelModal">Cancel</button>
          </td>
        </tr>
        <tr class="text-nowrap">
          <td>D002</td>
...
confirmCancel.addEventListener("click", function () {
  if (selectedRow) {
    selectedRow.querySelector(".status-cell span").innerText = "Cancelled";
  }
...
function filterTable() {
  ...
  tableRows.forEach(row => {
    ...
    const matchesSearch = food.includes(searchText) || donor.includes(searchText) || ngo.includes(searchText);
