  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto align-items-center">
        ...
        <li class="nav-item"><a class="nav-link" href="donor-dashboard">Donor Dashboard</a></li>
        <li class="nav-item"><a class="nav-link" href="addSurplusfood">Add Food</a></li>
        <li class="nav-item"><a class="nav-link" href="ngo-dashboard">NGO</a></li>
    ...
    <div class="card-body">
        <table class="table table-bordered ">
            ...
            <tbody>
                ...
                <td>23:00</td>
                <td class="donation-date d-none">2026-02-04</td>
                <td>Accepted</td>
                <td>
                 ...
                 <tr>
                    ...
                    <td>11:30</td>
                    <td class="donation-date d-none">2026-02-03</td>
                    <td>Completed</td>
                <td>
                    <button class="btn btn-sm btn-outline-primary">View</button>
                    <button class="btn btn-sm btn-outline-warning">Edit</button>
                ...
                <td>23:00</td>
                <td class="donation-date d-none">2026-02-05</td>
                <td>Accepted</td>
                <td>
                    <button class="btn btn-sm btn-outline-primary">View</button>
                    <button class="btn btn-sm btn-outline-warning">Edit</button>
...
function filterTable() {
    ...
    rows.forEach(row => {
        ...
        const rowDateText = row.querySelector(".donation-date").textContent;
        const rowDate = new Date(rowDateText);

        let rowType = "";
        if (rowFood.includes("veg") || rowFood.includes("vegetable")) rowType = "veg";
        else if (rowFood.includes("chicken") || rowFood.includes("mutton")||rowFood.includes("non")) rowType = "nonveg";
        ...
        let dateMatch = true;
        if (dateValue === "today") dateMatch = rowDate.toDateString() === today.toDateString();
        else if (dateValue === "thisWeek") dateMatch = rowDate >= startOfWeek && rowDate <= today;
