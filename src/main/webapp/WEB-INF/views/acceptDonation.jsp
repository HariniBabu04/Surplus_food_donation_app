...
<li class="nav-item"><a class="nav-link" href="viewDonation">View Donations</a></li>
...
<div class="input-group">
  ...
  <button type="button" class="btn btn-outline-secondary" onclick="openMap()"><i class="bi bi-geo-alt-fill"></i></button>
</div>
</div>
...
<button type="button" class="btn btn-success" onclick="window.location.href='pickup  '">Accept Donation</button>
<button type="button" class="btn btn-outline-danger" onclick="window.location.href='viewDonation  '">Cancel </button>
</div>
...
if(data){
  ...
  document.getElementById("donorContact").value = data.phone
}
function openMap() {
  let loc = document.getElementById("location").value
  if(loc) window.open("https://www.google.com/maps?q=" + encodeURIComponent(loc), "_blank")
}
</script>
