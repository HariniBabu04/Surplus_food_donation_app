...
<head>
    <meta charset="UTF-8">
    <title>Donor Dashboard | Surplus Food Donation System</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            <h4 class="text-center">Donor Panel</h4>
            <hr>
            <a href="donor-dashboard">Dashboard</a>
            <a href="addSurplusfood">Add Donation</a>
            <a href="manageDonation">Manage Donations</a>
            <a href="donation-status">Donation Status</a>
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-primary" onclick="window.location.href='addSurplusfood  '">+ Add New Donation</button>
            </div>
