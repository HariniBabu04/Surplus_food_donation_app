...
<head>
    <meta charset="UTF-8">
    <title>Donation Status | Surplus Food Donation System</title>
    ...
    <style>
        ...
        .picked { background-color: #2980b9; }
        .expired { background-color: #c0392b; }
    </style>
</head>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="manage-donations  ">Manage Donations</a>
